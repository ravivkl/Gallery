...
void print_message()
{
	...
	std::string massege(("project developer: raviv klein, the time: %s ", ctime(&my_time)));
	std::cout << "Welcome to raviv's Gallery!" << std::endl;
	std::cout << "now it's: " << ctime(&my_time) << std::endl;
	std::cout << "===================" << std::endl;
